...
namespace COCOA.Maestras
{
    public partial class frmFormulario : Form
    {
        ...
        private void formularioBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            if (!ValidarCampos()) return;
            this.Validate();
            this.formularioBindingSource.EndEdit();
        ...
        {
            descripcionFormularioTextBox.ReadOnly = true;
        ...
        {
            descripcionFormularioTextBox.ReadOnly = false;
        ...
        {
            HabilitarCampos();
            formularioBindingSource.AddNew();
            descripcionFormularioTextBox.Focus();
        }
        ...
        {
            this.formularioBindingSource.CancelEdit();
            DeshabilitarCampos();
        }
